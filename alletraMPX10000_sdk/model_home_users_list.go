...
// checks if the HomeUsersList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HomeUsersList{}

// HomeUsersList struct for HomeUsersList
type HomeUsersList struct {
	Items []UserListDetails `json:"items,omitempty"`
	// page limit
	PageLimit NullableInt32 `json:"pageLimit,omitempty"`
	// page offset
	PageOffset NullableInt32 `json:"pageOffset,omitempty"`
	// Number of users lists
...
// SetItems gets a reference to the given []UserListDetails and assigns it to the Items field.
...
func (o *HomeUsersList) SetPageLimitNil() {
	o.PageLimit.Set(nil)
}
...
func (o *HomeUsersList) SetPageOffsetNil() {
...
func (o *HomeUsersList) SetTotalNil() {
	o.Total.Set(nil)
}
...
func (o HomeUsersList) MarshalJSON() ([]byte, error) {
...
func (o HomeUsersList) ToMap() (map[string]interface{}, error) {
...
type NullableHomeUsersList struct {
	value *HomeUsersList
	isSet bool
}

func (v NullableHomeUsersList) Get() *HomeUsersList {
	return v.value
}

func (v *NullableHomeUsersList) Set(val *HomeUsersList) {
	v.value = val
	v.isSet = true
}

func (v NullableHomeUsersList) IsSet() bool {
	return v.isSet
}

func (v *NullableHomeUsersList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHomeUsersList(val *HomeUsersList) *NullableHomeUsersList {
	return &NullableHomeUsersList{value: val, isSet: true}
}

func (v NullableHomeUsersList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHomeUsersList) UnmarshalJSON(src []byte) error {
	v.isSet = true
